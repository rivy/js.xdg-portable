// origin: "https://cdn.jsdelivr.net/gh/denoland/deno@v1.46.3/cli/tsc/dts/lib.deno.unstable.d.ts"
// + `perl -ne "s#^///\s+<reference\s+lib=[\x22']deno.ns[\x22']\s+/>#/// <reference path='./lib.deno.ns.d.ts'/>#; print;"`
// + `perl -ne "s#^///\s+<reference\s+lib=[\x22']deno.broadcast_channel[\x22']\s+/>#/// <reference path='./lib.deno.broadcast_channel.d.ts'/>#; print;"`
// + `perl -ne "s#^///\s+<reference\s+lib=[\x22']deno.webgpu[\x22']\s+/>#/// <reference path='./lib.deno.webgpu.d.ts'/>#; print;"` // spell-checker:ignore webgpu

// Copyright 2018-2024 the Deno authors. All rights reserved. MIT license.

/// <reference no-default-lib="true" />
/// <reference path='./lib.deno.ns.d.ts'/>
/// <reference path='./lib.deno.broadcast_channel.d.ts'/>
/// <reference path='./lib.deno.webgpu.d.ts'/>
