// origin: "https://cdn.jsdelivr.net/gh/denoland/deno@v1.46.3/cli/tsc/dts/lib.deno.ns.d.ts"
// + `perl -ne "s#^///\s+<reference\s+lib=[\x22']deno.net[\x22']\s+/>#/// <reference path='./lib.deno.net.d.ts'/>#; print;"`

// Copyright 2018-2024 the Deno authors. All rights reserved. MIT license.

/// <reference no-default-lib="true" />
/// <reference lib="esnext" />
/// <reference path='./lib.deno.net.d.ts'/>
